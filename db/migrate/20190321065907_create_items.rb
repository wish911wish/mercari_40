class CreateItems < ActiveRecord::Migration[5.0]
  def change
    create_table :items do |t|
      ...
      t.text :description
      t.references :big_category, foreign_key: { to_table: :users }
      t.references :middle_category, foreign_key: { to_table: :users }
      t.references :small_category, foreign_key: { to_table: :users }
